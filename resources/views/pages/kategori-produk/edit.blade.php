...
<div class="bg-white shadow-lg rounded-xl overflow-hidden">
    ...
    <div class="p-6 border-b border-gray-200 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <h2 class="text-lg font-semibold text-gray-800">Edit Kategori Produk</h2>
    ...
    <form action="{{ route('admin.kategori_produk.update', $kategori_produk->id)}}" method="POST" enctype="multipart/form-data" class="p-6">
        @method('PUT')
        @csrf
