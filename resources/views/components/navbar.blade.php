...
<div class="header">
                ...
                <nav class="bg-white px-6 py-[10px] flex items-center justify-between shadow-sm">
                    ...
                    <div class="ml-3 hidden md:hidden lg:block">
                        ...
                        <input type="search" class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3 disabled:opacity-50 disabled:pointer-events-none" placeholder="Search" />
                        </form>
                    </div>
                    <!-- navbar nav -->
                    <ul class="flex ml-auto items-center">
                        ...
                        <a class="flex items-center gap-2" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-gray-800 font-medium block">John E. Grainger</span>
                            <!-- avatar -->
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-2" aria-labelledby="dropdownUser">
                            <div class="px-4 pb-0 pt-2  text-center">
                                <div class="leading-4  text-center">
                                    <span class="uppercase text-sm">Kelola Akun</span>
                                </div>
